...
export default {
  ...
  methods: {
    ...
    async fetchTodos() {
      try {
        const response = await fetch('https://fju-backend-todo-app.onrender.com/todos');  // Replace with your backend API URL
    ...
    async addTodo() {
      ...
      try {
        const response = await fetch('https://fju-backend-todo-app.onrender.com/todos', {
          method: 'POST',
          headers: {
